 ...
 */
 properties([
  [$class: 'GithubProjectProperty', projectUrlStr: 'https://github.com/nuxeo/jx-qa-jenkins/'],
...
void setGitHubBuildStatus(String context, String message, String state) {
  step([
    ...
    reposSource: [$class: 'ManuallyEnteredRepositorySource', url: 'https://github.com/nuxeo/jx-qa-jenkins'],
      ...
      steps {
        ...
        container('jx-base') {
          ...
          withEnv(["VERSION=${VERSION}"]) {
            echo "Building nuxeo/qa-jenkinsx:${VERSION}"
            sh """
